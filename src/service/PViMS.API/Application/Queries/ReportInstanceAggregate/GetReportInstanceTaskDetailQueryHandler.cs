...
{
    public class GetReportInstanceTaskDetailQueryHandler
        : IRequestHandler<GetReportInstanceTaskDetailQuery, TaskDto>
    {
        private readonly IRepositoryInt<ReportInstanceTask> _reportInstanceTaskRepository;
        private readonly ILinkGeneratorService _linkGeneratorService;
        private readonly IMapper _mapper;
        private readonly ILogger<GetReportInstanceTaskDetailQueryHandler> _logger;

        public GetReportInstanceTaskDetailQueryHandler(
            IRepositoryInt<ReportInstanceTask> reportInstanceTaskRepository,
            ILinkGeneratorService linkGeneratorService,
            IMapper mapper,
            ILogger<GetReportInstanceTaskDetailQueryHandler> logger)
        {
        ...
        public async Task<TaskDto> Handle(GetReportInstanceTaskDetailQuery message, CancellationToken cancellationToken)
        {
