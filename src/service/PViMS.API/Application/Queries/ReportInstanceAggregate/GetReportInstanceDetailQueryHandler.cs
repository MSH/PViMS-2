...
{
    public class GetReportInstanceDetailQueryHandler
        : IRequestHandler<GetReportInstanceDetailQuery, ReportInstanceDetailDto>
    {
        ...
        private readonly ILogger<GetReportInstanceDetailQueryHandler> _logger;

        public GetReportInstanceDetailQueryHandler(
            ...
            IMapper mapper,
            ILogger<GetReportInstanceDetailQueryHandler> logger)
        {
        ...
        public async Task<ReportInstanceDetailDto> Handle(GetReportInstanceDetailQuery message, CancellationToken cancellationToken)
        {
