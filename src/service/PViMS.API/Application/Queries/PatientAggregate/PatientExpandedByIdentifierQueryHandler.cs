...
{
    public class PatientExpandedByIdentifierQueryHandler
        : IRequestHandler<PatientExpandedByIdentifierQuery, PatientExpandedDto>
    {
        ...
        private readonly ILogger<PatientExpandedByIdentifierQueryHandler> _logger;
        private readonly ICustomAttributeService _customAttributeService;

        public PatientExpandedByIdentifierQueryHandler(
            ...
            IMapper mapper,
            ILogger<PatientExpandedByIdentifierQueryHandler> logger,
        ...
        public async Task<PatientExpandedDto> Handle(PatientExpandedByIdentifierQuery message, CancellationToken cancellationToken)
        {
            var searchTermParm = new SqlParameter("@SearchTerm", !String.IsNullOrWhiteSpace(message.SearchTerm) ? (Object)message.SearchTerm : DBNull.Value);

            var patientsFromRepo = _context.PatientLists
                .FromSqlRaw<PatientList>($"EXECUTE spSearchPatientsByIdentifier @SearchTerm"
                    , searchTermParm)
                .AsEnumerable();
