...
namespace PVIMS.API.Application.DomainEventHandlers.TaskAdded
{
                            ...
                            : INotificationHandler<CausalityConfirmedDomainEvent>
    {
        ...
        private bool ReportInstanceHasInvalidContactInformation(CausalityConfirmedDomainEvent domainEvent)
        {
        ...
        private List<MailboxAddress> PrepareDestinationMailBoxes(CausalityConfirmedDomainEvent domainEvent)
        {
