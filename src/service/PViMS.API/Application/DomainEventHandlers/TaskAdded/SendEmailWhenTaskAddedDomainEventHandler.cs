...
namespace PVIMS.API.Application.DomainEventHandlers.TaskAdded
{
                            ...
                            : INotificationHandler<TaskAddedDomainEvent>
    {
        ...
        private bool ReportInstanceHasInvalidContactInformation(TaskAddedDomainEvent domainEvent)
        {
        ...
        private List<MailboxAddress> PrepareDestinationMailBoxes(TaskAddedDomainEvent domainEvent)
        {
