DECLARE @Id int
SELECT @Id = Id   FROM Dataset  WHERE DatasetName = 'AEFI INVESTIGATION FORM'
...
INSERT [dbo].[Dataset] ([DatasetName], [Active], [InitialiseProcess], [RulesProcess], [Help], [Created], [LastUpdated], [ContextType_Id], [CreatedBy_Id], [UpdatedBy_Id], [IsSystem])
	VALUES ('AEFI INVESTIGATION FORM', 1, '', '', 'Serious Adverse Events Following Immunization reporting form', GETDATE(), GETDATE(), 4, 1, 1, 1)
...
INSERT [dbo].[DatasetCategory] ([DatasetCategoryName], [CategoryOrder], [Dataset_Id], [FriendlyName], [Help])
	VALUES ('Basic Details', 1, @dsid, 'Basic Details', 'Please enter some basic information about the details of the vaccination.') 
...
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
	VALUES ('Government health facility', 1, 0, 0, @fid) 
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
	VALUES ('Private health facility', 0, 0, 0, @fid) 
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
...
INSERT [dbo].[DatasetElement] ([ElementName], [Field_Id], [DatasetElementType_Id], [OID], [DefaultValue], [System], [DatasetElementGuid])
	VALUES ('Place of Vaccination', @fid, 1, '', '', 0, '4EC2B111-27F6-4E1D-B761-36D73792C693') 
...
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (1, @dscid, @deid, 1, 0, 'Place of vaccination', '') 
...
set @fid = (SELECT @@IDENTITY)
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
	VALUES ('Campaign', 1, 0, 0, @fid) 
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
	VALUES ('Routine', 0, 0, 0, @fid) 
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
	VALUES ('Other', 0, 1, 0, @fid) 
INSERT [dbo].[DatasetElement] ([ElementName], [Field_Id], [DatasetElementType_Id], [OID], [DefaultValue], [System], [DatasetElementGuid])
	VALUES ('Vaccination In', @fid, 1, '', '', 0, '111DC11D-4C1F-46A1-8EA4-AA13D132980C') 
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (2, @dscid, @deid, 1, 0, 'Vaccination In', '') 
set @dceid = (SELECT @@IDENTITY)
...
set @fid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetElement] ([ElementName], [Field_Id], [DatasetElementType_Id], [OID], [DefaultValue], [System], [DatasetElementGuid])
	VALUES ('Address of Vaccination Site', @fid, 1, '', '', 0, '61534D6D-2837-465B-8ACD-1C760561FBF9') 
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (3, @dscid, @deid, 0, 0, 'Address of vaccination site', '') 
set @dceid = (SELECT @@IDENTITY)
...
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (4, @dscid, @deid, 1, 0, 'Name of Reporting Officer', '') 
set @dceid = (SELECT @@IDENTITY)
...
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (5, @dscid, @deid, 1, 0, 'Designation / Position', '') 
set @dceid = (SELECT @@IDENTITY)
...
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (6, @dscid, @deid, 0, 0, 'Telephone # landline (with code)', '') 
set @dceid = (SELECT @@IDENTITY)
...
set @fid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetElement] ([ElementName], [Field_Id], [DatasetElementType_Id], [OID], [DefaultValue], [System], [DatasetElementGuid])
	VALUES ('Reporter Mobile Number', @fid, 1, '', '', 0, '738FE28E-A1A2-4405-8538-C2AD9EFCE708') 
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (7, @dscid, @deid, 0, 0, 'Telephone # Mobile', '') 
set @dceid = (SELECT @@IDENTITY)
...
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (8, @dscid, @deid, 0, 0, 'Contact e-mail address for reporter', '') 
set @dceid = (SELECT @@IDENTITY)
...
set @fid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetElement] ([ElementName], [Field_Id], [DatasetElementType_Id], [OID], [DefaultValue], [System], [DatasetElementGuid])
	VALUES ('Date of investigation', @fid, 1, '', '', 0, '93ADCB4D-6D6C-40DD-934A-3D2D98BBF9C1') 
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (9, @dscid, @deid, 0, 0, '93ADCB4D-6D6C-40DD-934A-3D2D98BBF9C1', '') 
set @dceid = (SELECT @@IDENTITY)
...
set @fid = (SELECT @@IDENTITY)
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
	VALUES ('First', 1, 0, 0, @fid) 
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
	VALUES ('Interim', 0, 0, 0, @fid) 
INSERT [dbo].[FieldValue] (Value, [Default], Other, Unknown, Field_Id)
	VALUES ('Final', 0, 0, 0, @fid) 
INSERT [dbo].[DatasetElement] ([ElementName], [Field_Id], [DatasetElementType_Id], [OID], [DefaultValue], [System], [DatasetElementGuid])
	VALUES ('AEFI Report Type', @fid, 1, '', '', 0, '79ABA1EC-3979-4BA2-80AF-1F817C8243B9') 
set @deid = (SELECT @@IDENTITY)
INSERT [dbo].[DatasetCategoryElement] ([FieldOrder], [DatasetCategory_Id], [DatasetElement_Id], [Acute], [Chronic], [FriendlyName], [Help])
	VALUES (10, @dscid, @deid, 1, 0, 'This report is', '') 
set @dceid = (SELECT @@IDENTITY)
