...
@Component({
  templateUrl: './form-a-tpt-conditions.popup.component.html',
  animations: egretAnimations
})
export class FormATPTConditionsPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FormATPTConditionsPopupComponent>,
