...
@Component({
  templateUrl: './form-a-tpt-medications.popup.component.html',
  animations: egretAnimations
})
export class FormATPTMedicationsPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FormATPTMedicationsPopupComponent>,
