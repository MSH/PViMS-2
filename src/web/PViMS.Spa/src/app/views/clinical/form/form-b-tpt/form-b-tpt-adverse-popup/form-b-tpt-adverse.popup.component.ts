...
@Component({
  templateUrl: './form-b-tpt-adverse.popup.component.html',
  animations: egretAnimations
})
export class FormBTPTAdversePopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FormBTPTAdversePopupComponent>,
