...
@Component({
  templateUrl: './form-a-tpt-labs.popup.component.html',
  animations: egretAnimations
})
export class FormATPTLabsPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FormATPTLabsPopupComponent>,
