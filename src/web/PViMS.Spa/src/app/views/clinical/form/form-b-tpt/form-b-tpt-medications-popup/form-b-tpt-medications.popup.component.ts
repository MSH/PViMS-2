...
@Component({
  templateUrl: './form-b-tpt-medications.popup.component.html',
  animations: egretAnimations
})
export class FormBTPTMedicationsPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FormBTPTMedicationsPopupComponent>,
