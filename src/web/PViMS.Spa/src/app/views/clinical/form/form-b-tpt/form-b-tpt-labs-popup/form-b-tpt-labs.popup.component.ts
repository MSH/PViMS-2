...
@Component({
  templateUrl: './form-b-tpt-labs.popup.component.html',
  animations: egretAnimations
})
export class FormBTPTLabsPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FormBTPTLabsPopupComponent>,
