...
export class DatasetElementService extends BaseService {
  ...
  getDatasetElementSubs(datasetElementId: number, filterModel: any): any {
      ...
      return this.Get<DatasetElementSubWrapperModel>(`/datasetelements/${datasetElementId}/elementsubs`, 'application/vnd.pvims.detail.v1+json', parameters);
  }
  ...
  getDatasetElementSubDetail(datasetElementId: number, id: number): any {
    ...
    return this.Get<DatasetElementExpandedModel>(`/datasetelements/${datasetElementId}/elementsubs`, 'application/vnd.pvims.detail.v1+json', parameters);
  }  
